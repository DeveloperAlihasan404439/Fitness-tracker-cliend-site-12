          ...
          <div className="drawer-side">
            ...
            ></label>
              <div className="menu px-5 bg-[#5b1ae9] h-screen">
                <h1 className="text-3xl text-center text-white uppercase mt-10  mb-5">
                  {
                ...
                {isAdmin || isTrainer? <>
                {
                  ...
                  {/* admin Dashboard  */}
                    <NavLink
                      ...
                      className="flex gap-5 items-center text-lg uppercase mb-2"
                    >
                      <SiSubstack/>
                  ...
                  {/* user Dashboard  */}
                    ...
                    <NavLink className="flex gap-5 items-center text-lg uppercase mb-2">
                      <h1>add review</h1>
                    </NavLink>
                    <NavLink className="flex gap-5 items-center text-lg uppercase mb-4">
                      <h1>my booking</h1>
                    </NavLink>
                  </>
                )}
